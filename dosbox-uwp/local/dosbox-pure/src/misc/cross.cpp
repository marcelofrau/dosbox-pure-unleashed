...
// UWP: directory enumeration not available via Win32 APIs
dir_information* open_directory(const char*) { return NULL; }
bool read_directory_first(dir_information*, char*, bool&) { return false; }
bool read_directory_next(dir_information*, char*, bool&) { return false; }
void close_directory(dir_information*) {}
