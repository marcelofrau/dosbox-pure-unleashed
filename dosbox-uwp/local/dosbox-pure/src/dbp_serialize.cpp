...
void DBPSerialize_All(DBPArchive& ar, bool dos_running, bool game_running)
{
	...
	// Serialize all subsystems in order. Keep small varying-size items last for delta encoding.
	#define DBPSERIALIZE_DECL(FUNC) void FUNC(DBPArchive& ar)
	DBPSERIALIZE_DECL(DBPSerialize_Mounts ); DBPSERIALIZE_DECL(DBPSerialize_DOS         );
	DBPSERIALIZE_DECL(DBPSerialize_CPU    ); DBPSERIALIZE_DECL(DBPSerialize_EMS         );
	DBPSERIALIZE_DECL(DBPSerialize_XMS    ); DBPSERIALIZE_DECL(DBPSerialize_Timer       );
	DBPSERIALIZE_DECL(DBPSerialize_CMOS   ); DBPSERIALIZE_DECL(DBPSerialize_DMA         );
	DBPSERIALIZE_DECL(DBPSerialize_FPU    ); DBPSERIALIZE_DECL(DBPSerialize_INT10       );
	DBPSERIALIZE_DECL(DBPSerialize_IO     ); DBPSERIALIZE_DECL(DBPSerialize_Mouse       );
	DBPSERIALIZE_DECL(DBPSerialize_Joystick);DBPSERIALIZE_DECL(DBPSerialize_VGA         );
	DBPSERIALIZE_DECL(DBPSerialize_VGA_Paradise);DBPSERIALIZE_DECL(DBPSerialize_VGA_Tseng);
	DBPSERIALIZE_DECL(DBPSerialize_VGA_XGA);DBPSERIALIZE_DECL(DBPSerialize_Render       );
	DBPSERIALIZE_DECL(DBPSerialize_SBLASTER);DBPSERIALIZE_DECL(DBPSerialize_OPL         );
	DBPSERIALIZE_DECL(DBPSerialize_TANDYSOUND);DBPSERIALIZE_DECL(DBPSerialize_CMS       );
	DBPSERIALIZE_DECL(DBPSerialize_DISNEY );DBPSERIALIZE_DECL(DBPSerialize_Paging       );
	DBPSERIALIZE_DECL(DBPSerialize_Memory  );DBPSERIALIZE_DECL(DBPSerialize_VGA_Draw    );
	DBPSERIALIZE_DECL(DBPSerialize_VGA_Memory);DBPSERIALIZE_DECL(DBPSerialize_PIC       );
	DBPSERIALIZE_DECL(DBPSerialize_Keyboard);DBPSERIALIZE_DECL(DBPSerialize_Drives      );
	DBPSERIALIZE_DECL(DBPSerialize_Files   );DBPSERIALIZE_DECL(DBPSerialize_GUS         );
	DBPSERIALIZE_DECL(DBPSerialize_MPU401  );DBPSERIALIZE_DECL(DBPSerialize_PCSPEAKER   );
	DBPSERIALIZE_DECL(DBPSerialize_Voodoo  );DBPSERIALIZE_DECL(DBPSerialize_CDPlayer    );
	DBPSERIALIZE_DECL(DBPSerialize_IDE     );
	#define DBPSERIALIZE_ENTRY(FUNC) { FUNC, NULL }
	#define DBPSERIALIZE_ENTRY_FVER(FUNC, VER_CHECK) { FUNC, [](DBPArchive& ar) -> bool { return (ar.version VER_CHECK); } }
	struct { void (*setup)(DBPArchive& ar); bool (*check)(DBPArchive&); } entries[] = {
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_Mounts,  >=8),
		DBPSERIALIZE_ENTRY(DBPSerialize_DOS         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_CPU         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_EMS         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_XMS         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_Timer       ),
		DBPSERIALIZE_ENTRY(DBPSerialize_CMOS        ),
		DBPSERIALIZE_ENTRY(DBPSerialize_DMA         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_FPU         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_INT10       ),
		DBPSERIALIZE_ENTRY(DBPSerialize_IO          ),
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_Mouse,   ==1),
		DBPSERIALIZE_ENTRY(DBPSerialize_Joystick    ),
		DBPSERIALIZE_ENTRY(DBPSerialize_VGA         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_VGA_Paradise),
		DBPSERIALIZE_ENTRY(DBPSerialize_VGA_Tseng   ),
		DBPSERIALIZE_ENTRY(DBPSerialize_VGA_XGA     ),
		DBPSERIALIZE_ENTRY(DBPSerialize_Render      ),
		DBPSERIALIZE_ENTRY(DBPSerialize_SBLASTER    ),
		DBPSERIALIZE_ENTRY(DBPSerialize_OPL         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_TANDYSOUND  ),
		DBPSERIALIZE_ENTRY(DBPSerialize_CMS         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_DISNEY      ),
		DBPSERIALIZE_ENTRY(DBPSerialize_Paging      ), // irregular size from here on
		DBPSERIALIZE_ENTRY(DBPSerialize_Memory      ),
		DBPSERIALIZE_ENTRY(DBPSerialize_VGA_Draw    ),
		DBPSERIALIZE_ENTRY(DBPSerialize_VGA_Memory  ),
		DBPSERIALIZE_ENTRY(DBPSerialize_PIC         ), // must be before Keyboard
		DBPSERIALIZE_ENTRY(DBPSerialize_Keyboard    ), // must be after PIC
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_Mouse,   >=2), // must be after PIC
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_Drives,  >=3),
		DBPSERIALIZE_ENTRY(DBPSerialize_Files       ),
		DBPSERIALIZE_ENTRY(DBPSerialize_GUS         ),
		DBPSERIALIZE_ENTRY(DBPSerialize_MPU401      ),
		DBPSERIALIZE_ENTRY(DBPSerialize_PCSPEAKER   ),
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_Voodoo,  >=5),
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_CDPlayer,>=6),
		DBPSERIALIZE_ENTRY_FVER(DBPSerialize_IDE,     >=8),
	};
	for (size_t i = 0; i < sizeof(entries)/sizeof(entries[0]); i++)
	{
		if (entries[i].check && !entries[i].check(ar)) continue;
		void (*func)(DBPArchive& ar) = entries[i].setup;
